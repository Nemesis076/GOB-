...
public class GoalSeeker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mGoals[2] = new Goal("Game", 3);
        mGoals[3] = new Goal("Exercise", 3);
        ...
        mActions[0].targetGoals.Add(new Goal("Game", +1f));
        mActions[0].targetGoals.Add(new Goal("Exercise", -1f));

        mActions[1] = new Action("sleep in the bed");
        mActions[1].targetGoals.Add(new Goal("Eat", -1f));
        mActions[1].targetGoals.Add(new Goal("Sleep", -4f));
        mActions[1].targetGoals.Add(new Goal("Game", +2f));
        mActions[1].targetGoals.Add(new Goal("Exercise", +3f));

        mActions[2] = new Action("visit the Computer");
        mActions[2].targetGoals.Add(new Goal("Eat", +1f));
        mActions[2].targetGoals.Add(new Goal("Sleep", +2f));
        mActions[2].targetGoals.Add(new Goal("Game", -4f));
        mActions[2].targetGoals.Add(new Goal("Exercise", -1f));

        mActions[3] = new Action("run on the treadmill");
        mActions[3].targetGoals.Add(new Goal("Eat", +2f));
        mActions[3].targetGoals.Add(new Goal("Sleep", +3f));
        mActions[3].targetGoals.Add(new Goal("Game", -1f));
        mActions[3].targetGoals.Add(new Goal("Exercise", -4f));
        ...
        mChangeOverTime.targetGoals.Add(new Goal("Game", +2f));
        mChangeOverTime.targetGoals.Add(new Goal("Exercise", +3f));
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.E))
        {
            ...
            {
                player.transform.position = new Vector3(2.3f, 4f, 10f);
            }
            if(bestThingToDo.name == "sleep in the bed")
            {
                player.transform.position = new Vector3(-8.5f, 4f, -9f);
            }
            if (bestThingToDo.name == "visit the Computer")
            {
                player.transform.position = new Vector3(9.2f, 4f, -11.7f);
            }
            if (bestThingToDo.name == "run on the treadmill")
            {
                player.transform.position = new Vector3(-11.2f, 4f, 7.4f);
            }
